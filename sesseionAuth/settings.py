"""
Django settings for sesseionAuth project.
...
SECRET_KEY = 'django-insecure-)+z67n@r9xm@%byq17&_97hfj=d&vn4djap2jh=vwe*-%=1up_'
...
ROOT_URLCONF = 'sesseionAuth.urls'
...
WSGI_APPLICATION = 'sesseionAuth.wsgi.application'
...
USE_TZ = False # for local time in expire session token 
...
AUTH_USER_MODEL = 'authAccount.User' # if you create your custome model then need to declare this
...
# this will activate session b default 
REST_FRAMEWORK = {
