...
import pdb # for debug test case and trace details 
...
class RegsiterViewTestCase(APITestCase):
    ...
    def _get_csrf_token(self): # this will generate csrf token so that we can test api eith csrf toekn 
    ...
    def test_get_csrf_token(self):
        ...
        # OR
        # self.assertEqual(response.cookies[0],'csrftoken')


    def test_register_view_success(self):
        url = reverse('register') # this is name that we define in urls py file (name='register')
